...
| [0027: 참조 세트와 생성 일관성 방식](0027-reference-sets-and-consistency-methods.md) | Accepted(부분) — 의상 단위 참조 세트(전신·얼굴)·재확인 필요·일관성 방식 선택과 params·제작 계획 강제. 생성 설정 불일치 처리는 Proposed. ADR-0010·0023 부분 변경 | 2026-09-23 |
...
2026-09-22: ADR-0021/0022의 외형 소유권·액세서리 합성 배치를 사용자 정정으로 갱신했다. 과거 그룹 스냅샷 보존 원칙과 ADR-0023 Negative 구분은 유지한다.

...
| [0027: 참조 세트와 생성 일관성 방식](0027-reference-sets-and-consistency-methods.md) | Accepted — 의상 단위 참조 세트(전신·얼굴)·재확인 필요·설정 불일치 경고·일관성 방식 선택과 params·제작 계획 강제. ADR-0010·0023 부분 변경 | 2026-09-23 |
